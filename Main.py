...
img_array = img_array.reshape(-1)  # Flatten the image

# Now img_array should be a 1D array with shape (784,)
prediction = predict_digit(img_array, 1)
print(prediction)
